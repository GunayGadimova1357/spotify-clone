    ...
    <div className="min-h-screen flex justify-center items-center bg-[#121212]">
      ...
      <div className="pt-30 min-h-screen min-w-screen sm:min-h-0 sm:min-w-0 w-full max-w-md flex flex-col items-center rounded-lg p-10 sm:p-12">
        ...
        <div className="flex flex-col justify-center gap-3 text-white font-semibold w-full">
          <button className="cursor-pointer w-full px-6 py-3 rounded-full text-base relative flex items-center border border-gray-600 hover:border-green-500">
          ...
          <button className="cursor-pointer w-full px-6 py-3 rounded-full text-base flex items-center border border-gray-600 hover:border-green-500">
            <FaApple className="w-6 h-6" />
            <span className="flex-1 text-center text-sm sm:text-base">
              {t("login.login_with")} Apple
            </span>
          </button>
        </div>
        ...
        <div className="text-white">
          {t("login.no_account")}?
          <a className="ml-1 text-green-400 no-underline" href="/signup">
            {t("login.sign_up")}
          </a>
        </div>
      </div>
